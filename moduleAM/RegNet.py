...
model.stem[0] = nn.Conv2d(1, 32, kernel_size=5, stride=1, padding=2, bias=False)  # 修改输入通道为1
num_features = model.fc.in_features
model.fc = nn.Linear(num_features, 2)  # 修改输出层为二分类
...
result_df.to_csv('RegNet_ILM_SNP.csv', index=False)
print("\n结果已保存至 RegNet_ILM_SNP.csv")
