...
# 定义模型
model = create_model('xception', pretrained=True)  # 禁用自动下载
model.conv1 = nn.Conv2d(1, 32, kernel_size=5, stride=1, padding=2, bias=False)  # 修改输入通道为1
...
result_df.to_csv('Xception_ILM_SNP.csv', index=False)
print("\n结果已保存至 Xception_ILM_SNP.csv")
